   ...
   <v-container grid-list-md fill-height fluid>
      <v-layout column>
         ...
         <v-flex d-flex md5>
            <v-layout row wrap>
               <v-flex d-flex md3>
                  <data-widget-text :averaged="true" :chartData="sampleChartData" parameter="RH" data_object="/ambience/AM-1/"
                                    :title="$t('message.network_consumption_per_m2')"
                                    :measurement="$t('message.kWh_per_meter')"></data-widget-text>
               </v-flex>
               <v-flex d-flex md3>
                  <data-widget-text :averaged="true" :chartData="sampleChartData" parameter="DP" data_object="/ambience/AM-1/"
                                    :title="$t('message.network_consumption_per_client')"
                                    :measurement="$t('message.kWh_per_client')"></data-widget-text>
               </v-flex>
               <v-flex d-flex md3>
                  <data-widget-text :averaged="true" :chartData="sampleChartData" parameter="WVP" data_object="/ambience/AM-1/"
                                    :title="$t('message.network_consumption_per_month')"
                                    :measurement="$t('message.kilowatt_per_hour')"></data-widget-text>
               </v-flex>
               <v-flex d-flex md3>
                  <data-widget-text :averaged="false" :chartData="sampleChartData" parameter="WBT" data_object="/ambience/AM-1/"
